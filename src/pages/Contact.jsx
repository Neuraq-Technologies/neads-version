          ...
          >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@neads.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Development Avenue<br />Empowerment City, EC 12345</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeIn} className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <form className="space-y-6">
                ...
                <button 
                  type="submit" 
                  className="w-full px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors shadow-md"
                >
                  Send Message
                </button>
              </form>
